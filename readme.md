-- --------------------------------------------------------
-- Database: caams_fyp
-- Versi ringkas: 3 jadual utama + 1 jadual sokongan
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Data untuk table `users`
-- --------------------------------------------------------

INSERT INTO `users` (`user_id`, `military_number`, `password`, `role`, `name`, `email`, `service_type`, `rank_level`, `created_at`) VALUES
(1, 'A123456', '$2y$10$zBvyVvJX1VLdZ3YzwFoW2eTj63AJZ/Ad7.YJkybLoUwAb/2TZZi6q', 'admin', 'Admin User', 'admin@fyp.com', 'darat', 'senior', '2026-01-07 13:10:53'),
(2, 'B234567', '$2y$10$zBvyVvJX1VLdZ3YzwFoW2eTj63AJZ/Ad7.YJkybLoUwAb/2TZZi6q', 'cadet', 'Ali Ahmad', 'ali@fyp.com', 'darat', 'junior', '2026-01-07 13:10:53'),
(3, 'C345678', '$2y$10$zBvyVvJX1VLdZ3YzwFoW2eTj63AJZ/Ad7.YJkybLoUwAb/2TZZi6q', 'rankholder', 'Mei Ling', 'mei@fyp.com', 'udara', 'senior', '2026-01-07 13:10:53'),
(4, 'D456789', '$2y$10$zBvyVvJX1VLdZ3YzwFoW2eTj63AJZ/Ad7.YJkybLoUwAb/2TZZi6q', 'cadet', 'Ahmad Lee', 'ahmad@fyp.com', 'laut', 'intermediate', '2026-01-07 13:10:53'),
(5, 'E567890', '$2y$10$zBvyVvJX1VLdZ3YzwFoW2eTj63AJZ/Ad7.YJkybLoUwAb/2TZZi6q', 'cadet', 'Siti Sarah', 'siti@fyp.com', 'udara', 'junior', '2026-01-07 13:10:53');
...
-- --------------------------------------------------------
-- Data untuk table `training_sessions`
-- --------------------------------------------------------
...
(1, 'Padang Kota', '2026-01-10', 'Fizikal', 'qrcode_123abc', 1, '2026-01-10 08:01:00', '2026-01-07 13:10:53'),
(2, 'Dewan Utama', '2026-01-11', 'Teori', 'qrcode_456def', 1, '2026-01-11 10:01:00', '2026-01-07 13:10:53'),
(3, 'Makmal Komputer', '2026-01-12', 'ICT', 'qrcode_789ghi', 1, '2026-01-12 14:01:00', '2026-01-07 13:10:53');
...
(1, 2, 1, '2026-01-10', 'present', NULL, NULL, 3, '2026-01-10 08:15:00', '2026-01-07 13:10:53'),
(2, 2, 2, '2026-01-11', 'late', NULL, 'Traffic jam', 3, '2026-01-11 10:20:00', '2026-01-07 13:10:53'),
(3, 4, 1, '2026-01-10', 'present', NULL, NULL, 3, '2026-01-10 08:10:00', '2026-01-07 13:10:53'),
(4, 4, 2, '2026-01-11', 'excused', 'medical_cert.pdf', 'Sakit demam', 3, '2026-01-11 09:30:00', '2026-01-07 13:10:53'),
(5, 5, 1, '2026-01-10', 'absent', NULL, NULL, NULL, NULL, '2026-01-07 13:10:53');

-- --------------------------------------------------------
-- Table structure for table `allowance_calculations`
-- --------------------------------------------------------
-- OPSIONAL: Jika perlukan sejarah kiraan elaun
...
-- --------------------------------------------------------
-- Data untuk table `allowance_calculations`
-- --------------------------------------------------------
...
(1, 2, '2026-01', 80.00, 100.00, 80.00, 10.00, 90.00, 1, '2026-01-07 13:10:53'),
(2, 4, '2026-01', 90.00, 100.00, 90.00, 15.00, 105.00, 1, '2026-01-07 13:10:53');
